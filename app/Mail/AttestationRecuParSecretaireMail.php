...
class AttestationRecuParSecretaireMail extends Mailable
{
    ...
    {
        return new Envelope(subject: '[COFIMA] Nouvelle demande d\'attestation - ' . $this->demande->user->name);
    }

    public function content(): Content
    {
        return new Content(
            view: 'emails.attestation.recu-secretaire',
            with: [
