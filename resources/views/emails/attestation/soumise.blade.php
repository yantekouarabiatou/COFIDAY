    ...
    <div style="padding: 30px;">
        ...
        <div style="background:#f8f9fa; border-radius:6px; padding:20px; margin:25px 0;">
            ...
            <table style="width:100%; border-collapse:collapse;">
                <tr>
                    <td style="padding:10px 12px; border-bottom:1px solid #dee2e6; font-weight:600;">Type :</td>
                    <td style="padding:10px 12px; border-bottom:1px solid #dee2e6;">{{ $demande->libelleType }}</td>
                </tr>
                <tr>
                    <td style="padding:10px 12px; border-bottom:1px solid #dee2e6; font-weight:600;">Destinataire :</td>
                    <td style="padding:10px 12px; border-bottom:1px solid #dee2e6;">{{ $demande->destinataire ?: 'Non spécifié' }}</td>
                </tr>
                @if($demande->inclure_salaire)
                <tr>
                    <td style="padding:10px 12px; border-bottom:1px solid #dee2e6; font-weight:600;">Salaire inclus :</td>
                    <td style="padding:10px 12px; border-bottom:1px solid #dee2e6;">{{ number_format($demande->salaire_net, 0, ',', ' ') }} FCFA</td>
                </tr>
                @endif
                <tr>
                    <td style="padding:10px 12px; font-weight:600;">Motif :</td>
                    <td style="padding:10px 12px;">{{ Str::limit($demande->motif, 100) }}</td>
                </tr>
            </table>
        </div>
        ...
        <p style="color:#666; font-size:.9rem; line-height:1.6;">
            ...
            <a href="{{ route('attestations.index') }}" style="color:#007bff; text-decoration:none;">espace personnel</a>.
        </p>
