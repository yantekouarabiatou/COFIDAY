...
@section('title', 'Nouveau solde de congés')
...
<section class="section">
    <div class="section-header">
        <h1><i class="fas fa-plus-circle"></i> Nouveau solde</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></div>
            <div class="breadcrumb-item"><a href="{{ route('admin.soldes.index') }}">Soldes</a></div>
            <div class="breadcrumb-item active">Créer</div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{ route('admin.soldes.store') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="annee" id="annee" class="form-control" required>
                                            @foreach($years as $year)
                                                <option value="{{ $year }}" {{ old('annee', now()->year) == $year ? 'selected' : '' }}>
                                                    {{ $year }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.5" min="0" max="50" name="jours_acquis" id="jours_acquis"
                                               class="form-control" value="{{ old('jours_acquis') }}" required>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.5" min="0" name="jours_pris" id="jours_pris"
                                               class="form-control" value="{{ old('jours_pris') }}" required>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.5" min="0" name="jours_reportes" id="jours_reportes"
                                               class="form-control" value="{{ old('jours_reportes', 0) }}">
...
$(document).ready(function() {
    ...
    // Mise à jour de l'aperçu du restant
